...
export const cropSeasons: CropSeason[] = [
  { id: 'safra-2026', tenantId: 'flor-de-lotus', name: 'Safra Verão', year: 2026, status: 'ativa', version: 1, updatedAt: now, updatedBy: 'u-admin' },
  { id: 'safra-2025', tenantId: 'flor-de-lotus', name: 'Safra Inverno', year: 2025, status: 'encerrada', version: 1, updatedAt: now, updatedBy: 'u-admin' }
];

export const fieldPlots: FieldPlot[] = [
  { id: 'plot-1', tenantId: 'flor-de-lotus', code: 'T-01', areaHectares: 42.5, soilType: 'Argiloso', currentSeasonId: 'safra-2026', version: 1, updatedAt: now, updatedBy: 'u-admin' },
  { id: 'plot-2', tenantId: 'flor-de-lotus', code: 'T-02', areaHectares: 37.2, soilType: 'Arenoso', currentSeasonId: 'safra-2026', version: 1, updatedAt: now, updatedBy: 'u-admin' }
];

export const herdLots: HerdLot[] = [
  { id: 'lot-1', tenantId: 'flor-de-lotus', code: 'L-NELORE', species: 'Bovino', breed: 'Nelore', headCount: 85, version: 1, updatedAt: now, updatedBy: 'u-admin' },
  { id: 'lot-2', tenantId: 'flor-de-lotus', code: 'L-CORTE', species: 'Bovino', breed: 'Angus', headCount: 64, version: 1, updatedAt: now, updatedBy: 'u-admin' }
];
